...
Is the growth and size of transmission lineages in the time period 2000-2017 dependent on any of the explanatory variables: Sex distribution in the clade, mtrD status, penA status, or final lineage size (transmission lineage size)?.

The input for the following analyses are all the transmission lineages containing more than 10 sequences from each location: (Norway, Australia, USA). For each of the transmission lineages we run [skygrowth v.0.3.1](https://github.com/mrc-ide/skygrowth) on the clades, and extract the growth rate of the effective population size in the time interval 2000-2017
...
mod_growthRate = lm(log(GrowthRate)~penA+sexDistribution+locations, data = total_data_large_scale)
summary(mod_growthRate)
coefplot(mod_growthRate)+theme_bw()
#Europe USA
