...
```{r remedy003, echo=F}
plot_importation_local_without_dates(tree = tree, result_import_local_transmission = imploc_NOR,start_time = 1750,date_breaks = 2,time_interval = c("2000-01-01","2018-01-01"), main_title = "Norway")
#dev.off()
```
