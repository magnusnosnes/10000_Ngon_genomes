...
<img src="../../Files/mtr_clade.png" width="500"/> <img src="../../Files/MIC_clade1.png" width="500"/> 
<img src="../../Files/MIC_clade2.png" width="500"/> <img src="../../Files/MIC_clade3.png" width="500"/> 
...
g1 = custom_skygrowth_plot(skyMtr,shift_time=1978.394, logy=F)+ggtitle("Mosaic mtr",)+
  theme(plot.title = element_text(hjust = 0.5))
g2 = custom_skygrowth_plot(skyhighMic_mosaic, shift_time=1958.606, logy=F)+ggtitle("High MIC mosaic penA")+
  theme(plot.title = element_text(hjust = 0.5))
g3 = custom_skygrowth_plot(skyhighMic_mosaic2, shift_time=1976.498, logy=F)+ggtitle("High MIC mosaic penA other clade")+
  theme(plot.title = element_text(hjust = 0.5))
g4 = custom_skygrowth_plot(skyhighMic_nonMosaic, shift_time=1940.751, logy=F)+ggtitle("High MIC non-mosaic penA")+
  theme(plot.title = element_text(hjust = 0.5))
