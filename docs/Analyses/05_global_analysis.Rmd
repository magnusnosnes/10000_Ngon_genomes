...
# Global metadata effective pupulation size analysis
...
p2 = p1+geom_facet(panel = "mtrMosaic", data =df_bar, geom = geom_col, 
  ...
  new_scale_color()+
   geom_facet(panel = "Sex", data =df_bar, geom = geom_col,
                 ...
                 ), orientation = 'y', width =1)+scale_fill_manual(breaks=c("non-mosaic","semi-mosaic","high","low","mosaic","mosaic1","mosaic2","mosaic3","mosaic4","F","M","nd"),values=cols)#scale_fill_brewer(palette="Paired")
