...
g6 = ggtree(g6, mrsd = "2019-08-01",aes(color=group))+scale_x_continuous(breaks=seq(1750,2020,20),expand=c(0,0))+scale_color_manual("Clade",values=color_mapping_tree)
