...
### [Investigating stability of estimates using downsampling](Analyses/07_simulation_results.html)

[<img src="Files/downsampling_analysis.png" width="500"/>](Analyses/07_simulation_results.html)

This page evaluates how reliable LineageHomology is in estimating import, export and local transmission of genomes in different locations. It uses a down-sampling method to test various scenarios of sampling density. The analysis focuses on four locations: Norway, Victoria, Europe and the USA.
