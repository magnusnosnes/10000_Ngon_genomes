...
The aim of this project is to investigate global transmission dynamics of *Neisseria gonorrhoeae* in the period 2015 - 2018. To do so we have collected a globally diverse sample of sequences.

#### Data preparation
Data preparation: Collection info, alignment, recombination masking, and SNP-calling are described in the paper (link will be posted). 

##### Phylogeny
The phylogenetic tree was produced with [FastTree v.2.1](https://doi.org/10.1371/journal.pone.0009490)
